                ...
                <div class="card-body">
                    <div class="feed-wrapper">
                        ...
                        <div class="feed-buttons">
                            <button class="btn report-button" :id="message.user.id" @click="modal = true, id = message.user.id" data-toggle="modal" data-target="#reportModal">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form method="post" @submit.prevent="submit">
                                        <div class="form-group">
                                            ...
                                            <input id="message" type="hidden" v-model="fields.message = message.message">
                                            <input id="user" type="hidden" v-model="fields.user = message.user_id">
