                ...
                <div class="card-deck d-flex">
                    <div class="card shadow-lg white">
                        <div class="card-body my-auto" style="background-image:url('Synthwave-Neon-80s-Background-4K.jpg');background-size:cover;background-repeat:no-repeat;background-position:center;">
                            <h4 class="card-title"><img class="rounded-circle mx-auto d-block" src="avatars/avatar5.jpeg" style="  width: 120px;
" /></h4>
                            <h3 class="text-center">{{$profileUser->name}}</h3>
                            <p>Status of this user</p>
                            <hr style="  {{$hr}}
" />
                            ...
                            <hr style="  {{$hr}};
" />
                            <div class="text-center"><a href="{{url('chat/create/'.$profileUser->id)}}"> <button class="btn btn-primary mx-auto" type="button" style="  width: 90%;
">Send a message</button></a></div>
                        </div>
                    </div>
